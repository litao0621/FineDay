...
public final class WeaterItem_
    extends WeaterItem
    implements HasViews, OnViewChangedListener
{
    ...
    public WeaterItem_(Context context) {
        super(context);
        init_();
    }

    public static WeaterItem build(Context context) {
        WeaterItem_ instance = new WeaterItem_(context);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.item_weater, this);
